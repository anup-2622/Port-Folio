              ...
              <div className="w-auto p-4 ">
                <a href="#">
                  <div className="inline-flex items-center">
                    ...
                    <span className="ml-4 text-lg font-bold text-white">Anup </span>
                  </div>
                </a>
              </div>
              <div className="w-auto p-4 ">
              <p className="text-sm font-medium  text-white">
        © { copyrightYear } Anup. All rights reserved.
      </p>
                {/* <ul className="-m-5 flex flex-wrap items-center">
                  ...
                  <li className="p-5">
                    <Link className="font-medium text-gray-600 hover:text-gray-700" href={'/contact'}>
                      Contact Us
                    </Link>
                  </li>
                </ul> */}
              ...
              <div className="w-auto p-4">
                <div className="-m-1.5 flex flex-wrap">
                  <div className="w-auto p-1.5">
                    <a href="#">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full border border-blue-800 hover:border-blue-500">
                        <svg
                          width="8"
                          height="14"
                          viewBox="0 0 8 14"
